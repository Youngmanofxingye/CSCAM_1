...
import argparse  # 添加：如果需要 Namespace
sys.path.append('../../../../')
from trainers import trainer, frn_train
from datasets import dataloaders
from models.FRN_tdm import FRN  # 修改：导入 TDM 版本（或重命名为 FRN）
...
fewshot_path = os.path.join(data_path,'miniImagenet_fewshot_cropped')
...
model = FRN(args=args)  # 修改：传递 args 以支持 TDM 等参数

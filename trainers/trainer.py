...
def train_parser():
    ...
    parser.add_argument('--TDM', action='store_true', help='enable TDM module')
    parser.add_argument('--model', type=str, default='FRN', choices=['Proto', 'FRN'],
                        help='model type for TDM (Proto or FRN)')
    parser.add_argument('--noise', action='store_true', help='enable noise in TDM')
    parser.add_argument('--noise_value', type=float, default=0.1, help='noise value for TDM (default 0.1)')
